...
I used these tools to build, test, and compare machine learning models across different tasks, including prediction, classification, clustering, and text-based analysis.
...
| Area | Tools | Main use |
|---|---|---|
| Machine learning | Python, scikit-learn, TensorFlow, LightGBM, WEKA | Building, testing, and comparing AI and ML models |
